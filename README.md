...
要使用真实 AI 决策，需要配置以下环境变量：

```bash
# AI 服务（至少配置一个）
ZHIPUAI_API_KEY=your_key  # 推荐，智谱 AI
# OPENAI_API_KEY=your_key  # 或 OpenAI

# 可选：增强功能
GITHUB_TOKEN=your_token    # 真实扫描 GitHub
STRIPE_SECRET_KEY=your_key # 真实支付
```
